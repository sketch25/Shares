...
## アプリケーション説明
Sharesは情報共有アプリケーションです。<br>
個人に価値の集まるこの時代だからこそ、情報の発信源が重要になってきました。<br>
...
### Step6 検索
検索には２種類あります。<br>
検索ボックス・・・キーワードを入力すると全投稿から該当記事を検索<br>
...
### Haml/Sass/Ruby(Ruby on Rails)/<br>AWS(EC2, S3, Route53)/Docker
